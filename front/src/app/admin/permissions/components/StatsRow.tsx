...
import { Database, Lock, Settings, Zap } from 'lucide-react';
import type { PermissionStats } from '@/types/permission';

export const StatsRow = ({ stats }: { stats?: PermissionStats | null }) => {
    if (!stats) {
        return (
